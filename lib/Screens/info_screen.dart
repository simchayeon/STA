          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () => _launchURL(
                  'https://jw4.mju.ac.kr/user/indexMain.action?command=&siteId=cs'), // 홈페이지 연결 버튼 클릭 시 URL 호출
              child: const Text('홈페이지 연결'), // 버튼 텍스트
            ),
            SizedBox(height: 16), // 위젯 간 간격
            ElevatedButton(
              onPressed: () => _launchURL(
                  'https://core-courses-website.com'), // 핵심 교양 확인 버튼 클릭 시 URL 호출
              child: const Text('핵심교양 확인'), // 버튼 텍스트
            ),
            SizedBox(height: 16), // 위젯 간 간격
            ElevatedButton(
              onPressed: () => _launchURL(
                  'https://common-courses-website.com'), // 공통 교양 확인 버튼 클릭 시 URL 호출
              child: const Text('공통교양 확인'), // 버튼 텍스트
            ),
            SizedBox(height: 16), // 위젯 간 간격
            ElevatedButton(
              onPressed: () => _launchURL(
                  'https://curriculum-website.com'), // 학과별 커리큘럼 버튼 클릭 시 URL 호출
